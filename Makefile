...
$(call party,party3.c,party2,Base1 System1 Ast2 Map Parser2 Kiselyov1 Unify1 RTS2 Typer3 party1)
$(call party,crossly.c,party3,Base1 System1 Ast3 Map Parser3 Kiselyov1 Unify1 RTS3 Typer4 party2)
$(call party,precisely.c,crossly,BasePrecisely System1 AstPrecisely Map ParserPrecisely Kiselyov1 Unify1 RTSPrecisely TyperPrecisely precisely)
$(call party,traced.c,crossly,BasePrecisely System1 AstPrecisely Map ParserPrecisely Kiselyov1 Unify1 RTSTrace TyperPrecisely party2)

$(call party,check.c,precisely,BasePrecisely System1 AstPrecisely Map ParserPrecisely Kiselyov1 Unify1 RTSPrecisely TyperPrecisely precisely)

$(call party,webby.c,precisely,BasePrecisely System1 AstPrecisely Map ParserPrecisely Kiselyov1 Unify1 RTSPrecisely TyperPrecisely Webby WartsBytes)
$(call party,webby.wasm,webby,BasePrecisely SystemWasm AstPrecisely Map ParserPrecisely Kiselyov1 Unify1 RTSPrecisely TyperPrecisely Webby WartsBytes)
