...
knew a thing or two about compilers. I loved the dragon book as an undergrad.
In contrast, I only scraped through Databases by cramming a textbook the night
before, most of whose contents I promptly forgot afterwards. Why didn't I
pass? I resolved to one day unravel the mystery by learning more about
compilers.

I have since sporadically read about various compiler topics. Did my younger
self did deserve to fail? Maybe. There were certainly gaps in that guy's
knowledge (which are only marginally smaller now). On the other hand, there
are equally alarming gaps in my textbooks, so maybe I shouldn't have failed.
...
https://www.microsoft.com/en-us/research/uploads/prod/2018/03/build-systems-final.pdf[Build systems can be defined mathematically]. (And it turns out
Excel is a build system.)
