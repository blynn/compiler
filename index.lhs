...
* https://dl.acm.org/doi/pdf/10.1145/3677999.3678280[Lennart Augustsson, MicroHs: A Small Compiler for Haskell], and https://github.com/augustss/MicroHs[its accompanying source] looks amazing, though its goals differ ever so slightly to mine. While MicroHs also can be built with a C compiler, it relies on a large chunk of C that was generated by a Haskell program.
